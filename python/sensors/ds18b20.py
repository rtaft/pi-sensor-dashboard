...
class DS18B20(FileBasedSensor):
    def __init__(self, id_=None, name=None, path=None):
        FileBasedSensor.__init__(self, id_=id_, name=name, units='C', path=path, regexp='t=(\d*)', factor=.001)
...
def lookup(existing_config):
    ...
    if filtered:
        ...
        sensor = DS18B20(1, name, selected)
