...
class MCP3008:
    def __init__(self, name=None, spi_port=None, spi_device=None, clk=None, miso=None, mosi=None, cs=None):
...
class AnalogSensor(Sensor):
    def __init__(self, name=None, index=None, units=None, slope=None, y_intercept=None):
